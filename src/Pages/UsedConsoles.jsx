...
import UsedConsoleSidebar from '../Components/UsedConsoleSidebar'
...
const UsedConsoles = () => {
    ...
    const getUsedConsoles = async () => {
        setLoading(true)
        try {
            const response = await fetch(`${process.env.REACT_APP_BASE_URL}/products/usedconsoles/console&used`)
        ...
        <div className='homepage flex flex-col justify-between'>
            ...
            <div className='main-container w-[100%] self-center flex flex-col justify-center min-h-screen'>
                <h1 className='page-title text-center text-3xl font-semibold self-center my-5 pb-5 w-[70%]'
                    style={{ borderBottom: "1px solid #eaeaea" }}>Console Usate</h1>
                <UsedConsoleSidebar
                    usedConsoles={consoles}
                    setRenderedUsedConsoles={setRenderedConsoles}
                />
            ...
            <div className='mt-5 flex flex-row justify-center'>
                <p>Pagina: {products.currentPage} / {products.totalPages}</p>
            </div>
